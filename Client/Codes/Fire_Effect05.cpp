...
CFire_Effect05::CFire_Effect05(LPDIRECT3DDEVICE9 pGraphicDev)
: CEffect(pGraphicDev)
, m_pRendererCom(NULL)
...
CFire_Effect05::~CFire_Effect05(void)
{

}

HRESULT CFire_Effect05::Ready_GameObject(_vec3 vPos)
{
	if(FAILED(Ready_Component()))
		return E_FAIL;

	m_pTransformCom->Set_Infomation(Engine::CTransform::INFO_POSITION, vPos.x, 0.3f, vPos.z);
	m_pTransformCom->Set_Infomation(Engine::CTransform::INFO_SCALE, 0.1f, 0.1f, 0.1f);

	return S_OK;
}

_int CFire_Effect05::Update_GameObject(const _float& fTimeDelta)
{	
...
void CFire_Effect05::Render_GameObject(void)
{
...
HRESULT CFire_Effect05::Ready_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Component(SCENE_STAGE, L"Component_Texture_Fire05");
...
CFire_Effect05* CFire_Effect05::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CFire_Effect05* pInstance = new CFire_Effect05(pGraphicDev);

	if(FAILED(pInstance->Ready_GameObject(vPos)))
	{
		MSG_BOX("CFire_Effect05 Created Failed");
		::Safe_Release(pInstance);
	}
	return pInstance;
}

void CFire_Effect05::Free(void)
{	
