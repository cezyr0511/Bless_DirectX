...
CImpact2::CImpact2(LPDIRECT3DDEVICE9 pGraphicDev)
...
CImpact2::~CImpact2(void)
{

}

HRESULT CImpact2::Ready_GameObject(void)
{
...
_int CImpact2::Update_GameObject(const _float& fTimeDelta)
{
	...
	if(m_iSKNum == 4 || m_iSKNum == 6)
	{
		if(m_iSKNum == 4 && m_dAniPosition > 0.25f && m_dAniPosition <= 0.27f)
		{
			...
			m_pTransformCom->Set_Infomation(Engine::CTransform::INFO_POSITION, &Engine::_vec3(vPos.x, 0.263f, vPos.z));
...
void CImpact2::Render_GameObject(void)
{
...
HRESULT CImpact2::Ready_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Component(SCENE_STAGE, L"Component_Texture_Impact01");
...
CImpact2* CImpact2::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CImpact2* pInstance = new CImpact2(pGraphicDev);

	if(FAILED(pInstance->Ready_GameObject()))
	{
		MSG_BOX("CImpact2 Created Failed");
		::Safe_Release(pInstance);
	}
	return pInstance;
}

void CImpact2::Free(void)
{
