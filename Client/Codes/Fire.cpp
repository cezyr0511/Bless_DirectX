...
HRESULT CFire::Ready_GameObject(_vec3 vPos)
{
	...
	m_pTransformCom->Rotation(Engine::CTransform::ANGLE_X, D3DXToRadian(180));
	m_pTransformCom->Set_Infomation(Engine::CTransform::INFO_POSITION, vPos.x, vPos.y + 0.3f, vPos.z);
