...
CHit2::CHit2( LPDIRECT3DDEVICE9 pGraphicDev )
: CEffect(pGraphicDev)
, m_pRendererCom(NULL)
...
HRESULT CHit2::Ready_GameObject(void)
{
...
_int CHit2::Update_GameObject( const _float& fTimeDelta )  
{
...
void CHit2::Render_GameObject( void )
{
...
HRESULT CHit2::Ready_Component( void )
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Component(SCENE_STAGE, L"Component_Texture_Hit02");
...
CHit2* CHit2::Create( LPDIRECT3DDEVICE9 pGraphicDev)
{
	CHit2*	pInstance = new CHit2(pGraphicDev);

	if(FAILED(pInstance->Ready_GameObject()))
	{
		MSG_BOX("CHit2 Created Failed");
		::Safe_Release(pInstance);
	}
	return pInstance;
}

void CHit2::Free( void )
{
