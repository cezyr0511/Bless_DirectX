...
CFire_Effect01::CFire_Effect01(LPDIRECT3DDEVICE9 pGraphicDev)
: CEffect(pGraphicDev)
, m_pRendererCom(NULL)
...
CFire_Effect01::~CFire_Effect01(void)
{

}

HRESULT CFire_Effect01::Ready_GameObject(_vec3 vPos)
{
	if(FAILED(Ready_Component()))
		return E_FAIL;

	m_pTransformCom->Set_Infomation(Engine::CTransform::INFO_POSITION, vPos.x, 0.33f, vPos.z);
	
	return S_OK;
}

_int CFire_Effect01::Update_GameObject(const _float& fTimeDelta)
{	
...
void CFire_Effect01::Render_GameObject(void)
{
...
HRESULT CFire_Effect01::Ready_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Component(SCENE_STAGE, L"Component_Texture_Fire01");
...
CFire_Effect01* CFire_Effect01::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CFire_Effect01* pInstance = new CFire_Effect01(pGraphicDev);

	if(FAILED(pInstance->Ready_GameObject(vPos)))
	{
		MSG_BOX("CFire_Effect01 Created Failed");
		::Safe_Release(pInstance);
	}
	return pInstance;
}

void CFire_Effect01::Free(void)
{	
