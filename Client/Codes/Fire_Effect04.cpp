...
CFire_Effect04::CFire_Effect04(LPDIRECT3DDEVICE9 pGraphicDev)
: CEffect(pGraphicDev)
, m_pRendererCom(NULL)
...
CFire_Effect04::~CFire_Effect04(void)
{

}

HRESULT CFire_Effect04::Ready_GameObject(_vec3 vPos)
{
...
_int CFire_Effect04::Update_GameObject(const _float& fTimeDelta)
{	
...
void CFire_Effect04::Render_GameObject(void)
{
...
HRESULT CFire_Effect04::Ready_Component(void)
{
	...
	m_pTextureCom = (Engine::CTexture*)Engine::Clone_Component(SCENE_STAGE, L"Component_Texture_Fire04");
...
CFire_Effect04* CFire_Effect04::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CFire_Effect04* pInstance = new CFire_Effect04(pGraphicDev);

	if(FAILED(pInstance->Ready_GameObject(vPos)))
	{
		MSG_BOX("CFire_Effect04 Created Failed");
		::Safe_Release(pInstance);
	}
	return pInstance;
}

void CFire_Effect04::Free(void)
{	
