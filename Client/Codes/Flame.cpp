...
CFlame::CFlame(LPDIRECT3DDEVICE9 pGraphicDev)
...
HRESULT CFlame::Ready_GameObject(void)
{
...
_int CFlame::Update_GameObject(const _float& fTimeDelta)
{
...
void CFlame::Render_GameObject(void)
{
...
HRESULT CFlame::Ready_Component(void)
{
...
HRESULT CFlame::SetUp_ConstantTable(LPD3DXEFFECT pEffect)
{
...
CFlame* CFlame::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFlame* pInstance = new CFlame(pGraphicDev);

	if(FAILED(pInstance->Ready_GameObject()))
	{
		MSG_BOX("CFlame Created Failed");
