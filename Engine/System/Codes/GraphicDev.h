...
// 1. 그래픽카드의 정보를 조사한다.
// 2. 조사한 내용을 바타응로 장치를 사용할 수 있도록 준비시킨다.
...
public:
	HRESULT Initialize_GraphicDev(HWND hWnd, WINMODE eMode, const _uint& iSizeX, const _uint& iSizeY, Engine::CGraphicDev** ppGraphicDev);
	void Render_Begin(D3DXCOLOR Color);
	void Render_End(void);

private:
	// m_pGrpahicDev장치를 생성해주는 역할
	// 장치의 성능을 조사하는 역할
	LPDIRECT3D9						m_pSDK;
