...
HRESULT Engine::CFont::Initialize_Font(const _tchar* pFontType, const _uint& iWidth, const _uint& iHeight, const _uint& iWeight)
{
...
{
	RECT  rcFont = {pPosition->x, pPosition->y};
...
CFont* Engine::CFont::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar* pFontType, const _uint& iWidth, const _uint& iHeight, const _uint& iWeight)
{
	...
	if(FAILED(pFont->Initialize_Font(pFontType, iWidth, iHeight, iWeight)))
	{
