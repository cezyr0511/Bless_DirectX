...
HRESULT Engine::CBoxCollider::Compute_Collider(Engine::CStatic_Mesh* pMesh)
{
...
HRESULT Engine::CBoxCollider::Compute_Collider(Engine::CStatic_Mesh* pMesh, const _matrix* pWorldMatrix)
{
	pMesh->Compute_MinMax(&m_vMin, &m_vMax);
...
HRESULT Engine::CBoxCollider::Compute_Collider(Engine::CDynamic_Mesh* pMesh, const _uint& iMeshContainerIdx, const _matrix* pWorldMatrix)
{
...
HRESULT Engine::CBoxCollider::Compute_Collider(Engine::CDynamic_Mesh* pMesh, const _uint& iMeshContainerIdx)
{
	pMesh->Compute_MinMax(&m_vMin, &m_vMax, iMeshContainerIdx);
...
void Engine::CBoxCollider::Render_Collider(COLLTYPE eType, _bool isColl, const _matrix* pWorldMatrix)
{
	if(TYPE_AABB == eType)
	{
		_matrix			matScale, matTrans;
...
_bool Engine::CBoxCollider::Collision_OBB(CBoxCollider* pTargetCollider)
{
	Set_PointInfo();
