...
MyTool.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMyToolApp 응용 프로그램
    클래스를 선언합니다.

MyTool.cpp
    응용 프로그램 클래스 CMyToolApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Toolbar.bmp
    ...
    MyTool.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
MyToolDoc.h, MyToolDoc.cpp - 문서
    이 파일에는 CMyToolDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMyToolDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

MyToolView.h, MyToolView.cpp - 문서 뷰
    이 파일에는 CMyToolView 클래스가 들어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 MyTool.pch와
